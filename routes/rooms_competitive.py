...
bp = Blueprint('rooms_competitive', __name__)

rooms = {}

@bp.route('/create_room_competitive', methods=['POST'])
def create_room():
...
@bp.route('/join_room_competitive', methods=['POST'])
def join_room():
    room_id = request.json.get('room_id')
    user = request.json.get('user')
    if room_id in rooms:
...
# @bp.route('/leave_room_competitive', methods=['POST'])
# def leave_room():
#     room_id = request.json.get('room_id')
#     user = request.json.get('user')
